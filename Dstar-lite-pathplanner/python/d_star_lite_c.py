...
class DStarLite_C:
    def __init__(self, map: OccupancyGridMap, s_start: (int, int), s_goal_c: (int, int)):
        """
        ...
        self.rhs[self.s_goal_c] = 0
        self.U.insert(self.s_goal_c, Priority(heuristic(self.s_start, self.s_goal_c), 0))
    ...
    def move_and_replan(self, robot_position: (int, int)):
        ...
        while self.s_start != self.s_goal_c:
